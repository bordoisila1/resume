...
const homeContentItems =
    {
        ...
        "venenatis sit amet, blandit vitae lorem. Maecenas lorem augue, vestibulum vel " +
        "bibendum nec, faucibus in eros.\n" +
        "\n" +
        "Vestibulum sodales faucibus porta. Nulla facilisi. Pellentesque pharetra " +
        "id tellus sed ultricies. Cras scelerisque vitae orci nec condimentum. Sed eros metus" +
        ", euismod ac dolor sed, tincidunt ultrices tortor. Etiam imperdiet ut lectus et luctu" +
        "s. Donec sem nisl, interdum quis justo eu, lacinia suscipit dolor. Curabitur vel est " +
        "mattis, venenatis leo non, consectetur justo. Pellentesque tincidunt diam quis justo" +
        " mattis efficitur. Proin sodales lorem lectus, eu feugiat ligula feugiat id. Fusce " +
        "tortor diam, efficitur in ante a, tristique lacinia elit. Integer malesuada ullam" +
        "corper libero vitae tempor.\n" +
        "\n"+
        "<p>Aliquam mattis erat nec scelerisque sodales. " +
        "Morbi tempor, velit nec feugiat mollis, elit ex porta arcu, " +
        "finibus malesuada odio nulla in felis. Interdum et malesuada " +
        "fames ac ante ipsum primis in faucibus. Sed hendrerit ligula " +
        "sed nisl luctus, id dignissim ante viverra. Fusce semper magna " +
        "at commodo semper. Mauris est nunc, convallis vitae volutpat " +
        "eu, porttitor ac erat. Nam accumsan lorem ac consectetur mollis." +
        " Maecenas porttitor rhoncus nisl vel tristique. Duis tristique " +
        "eros sit amet libero ornare pharetra. Duis at ex lacus. Duis " +
        "nec massa in orci tristique porta. Mauris varius nibh vel " +
        "purus finibus placerat. Aliquam pulvinar est scelerisque " +
        "turpis auctor efficitur. Donec nisi orci, eleifend eget " +
        "aliquet faucibus, commodo eu augue. Vivamus facilisis " +
        "facilisis leo id elementum.</p>\n" +
        "\n"+
        "<img class='img-fluid rounded float-right' src='/images/github_logo.jpg'/>" + "\n" +
        ...
        "perdiet consequat.\n" +
        "\n" +
        "Mauris a neque pharetra, </p>" + "<p>Morbi faucibus turpis quis dui congue, quis fri" +
        "ngilla tellus " +
        "venenatis. Suspendisse risus metus, scelerisque in sapien ac, " +
        "ultrices iaculis est. Sed vel nunc tempus, condimentum tellus a" +
        "c, ornare massa. Proin accumsan nec justo eget imperdiet." +
